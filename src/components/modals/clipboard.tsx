...
export const ClipboardModal = componentize<Props, Actions, Locals>({
    textAreaValue: '',
    errorMessage: undefined,
}, (hub, initState) => {
    // Members

    const modal = createModal(Scenes.Clipboard);

    // テト譜の変換
    const encodePromise = (async () => {
        const cachePages = new CachePages(initState.pages);
                ...
                <div key="clipboard-modal-top">
                    <div key="mdl-clipboard" datatest="mdl-clipboard"
                        ...
                        <div key="modal-footer" className="modal-footer">
                            <a href="#" key="btn-clipboard-cancel"
                               datatest="btn-clipboard-cancel" id="btn-clipboard-cancel"
